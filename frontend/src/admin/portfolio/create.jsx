...
export default function CreatePortfolio() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API}/admin/portfolio-category`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Append cover image - matching the expected structure in backend
      if (formData.cover_img) {
        formDataToSend.append('cover_img', formData.cover_img);
      }

      const response = await axios.post(`${import.meta.env.VITE_API}/admin/portfolio`, formDataToSend, {
        headers: {
        ...
        <div className="row">
          <div className="col-12">
            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
              <h4 className="mb-sm-0 font-size-18">Create Portfolio</h4>
              <div className="page-title-right">
                <ol className="breadcrumb m-0">
                  <li className="breadcrumb-item">
                    <a href="javascript: void(0);">Portfolio</a>
                  </li>
                  <li className="breadcrumb-item active">Create Portfolio</li>
                </ol>
              </div>
            </div>
          </div>
