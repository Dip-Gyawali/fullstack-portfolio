...
export default function EditTestimonial() {
  ...
  useEffect(() => {
    const fetchTestimonial = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API}/admin/testimonial/${id}`);
        const testimonial = response.data;
        setFormData({
          testimonial_name: testimonial.testimonial_name,
          testimonial_designation: testimonial.testimonial_designation,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`${import.meta.env.VITE_API}/admin/testimonial/${id}`, formDataToSend, {
        headers: {
        ...
        <div className="row">
          <div className="col-12">
            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
              <h4 className="mb-sm-0 font-size-18">Edit Testimonial</h4>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="row">
                    <div className="col-lg-6">
                      <div>
                        <div className="mb-3">
                          <label htmlFor="testimonial_name" className="form-label">Name</label>
                          <input
                            type="text"
                        ...
                        <div className="mb-3">
                          <label htmlFor="testimonial_designation" className="form-label">Designation</label>
                          <input
                            type="text"
                            className="form-control"
                        ...
                        <div className="mb-3">
                          <label htmlFor="testimonial_message" className="form-label">Message</label>
                          <Editor
                            apiKey="9kp5xb6yatz2q6waohzmrffy7bhqqo02307mgo0ced26kp9k"
                            value={formData.testimonial_message}
                        ...
                        <div className="mb-3">
                          <label htmlFor="image" className="form-label">
                            {formData.currentImage ? 'Change Image (optional)' : 'Upload Image'}
                          </label>
                          <input
                            className="form-control"
                            type="file"
